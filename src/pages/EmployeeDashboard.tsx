...
interface EmployeeDashboardProps {
  user: User;
  /**
   * True only for the primary, routed employee dashboard (URL /dashboard). When
   * true, the active sub-tab is synced to the URL (/dashboard/history …) so it
   * survives a refresh. Left false when this component is embedded in another

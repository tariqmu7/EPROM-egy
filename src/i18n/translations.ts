...
export const DICTIONARIES: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'nav.trainingNeeds': 'Training Needs',
    'nav.trainingCatalogue': 'Training Catalogue',
  ...
  ar: {
    ...
    'nav.workExperience': 'الخبرة العملية',
    'nav.trainingNeeds': 'الاحتياجات التدريبية',
    'nav.trainingCatalogue': 'دليل الدورات التدريبية',
